...
class DBAccess(ABC):
    ...
    def run_sql(self, sql: str, **kwargs) -> pd.DataFrame:
        ...
        """
        raise Exception(
            "You need to connect to a database first by running db.connect_to_snowflake(), db.connect_to_postgres(), similar function, or manually set db.run_sql"
        )
